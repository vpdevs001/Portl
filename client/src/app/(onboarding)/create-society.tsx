...
export default function CreateSociety() {
  ...
  return (
    <ScrollView className="flex-1 bg-background px-6 py-12">
      {/* Back Button */}
      <View className="mb-6">
        <Pressable onPress={() => router.back()} className="flex-row items-center py-1">
      ...
      <View className="mb-8">
        ...
        <Text className="text-sm font-sans text-foreground-secondary leading-5">
          Establish the identity of your residential estate or commercial building to manage towers, flats, and members.
        </Text>
      </View>
