import { useMyInvites, useRespondInvite } from '@/hooks/use-invite';
  ...
  return (
    <ScrollView className="flex-1 bg-background px-6 py-12">
      ...
      <View className="flex-row justify-between items-center mb-8">
        ...
        <Pressable onPress={handleSignOut} className="px-3 py-1.5 rounded-lg bg-surface border border-border">
      ...
      <View className="mb-8">
        ...
        <Text className="text-sm font-sans text-foreground-secondary leading-6">
          To enter, you need to accept an invitation from your society administrator or register a new society if you are an administrator.
        </Text>
      </View>
                ...
                <View key={invite.id} className="p-5 bg-card border border-border rounded-xl gap-4">
                  ...
                  <View className="flex-row gap-3 pt-2">
                    <Pressable
                      ...
                      className="flex-1 py-2.5 rounded-lg border border-danger/30 bg-danger/5 active:bg-danger/10 items-center"
                    >
                    ...
                    <Pressable
                      ...
                      className="flex-1 py-2.5 rounded-lg bg-primary active:opacity-90 items-center"
                    >
      ...
      <View className="p-6 bg-surface border border-border rounded-2xl gap-4 mb-16">
        <View className="gap-1">
          ...
          <Text className="text-xs font-sans text-foreground-secondary leading-5">
            If you are developing a new estate or setting up administrative controls for your tower, start here.
          </Text>
        </View>

        <Pressable
          onPress={() => router.push('/(onboarding)/create-society')}
          className="w-full py-3.5 rounded-xl border border-primary bg-card active:bg-surface items-center justify-center"
        >
